...
Copy the content of this repository to Igor's User Procedures folder. Then, to use the software, follow the instructions below.
...
| Find       | (optional) Option to find pauses (default), change points and pauses, or only change points |
|------------+---------------------------------------------------------------------------------------------|


If no Y err wave is provided, σ is assumed to be constant and estimated from the trajectory.

The results will be displayed in a new window (red: paused segments, green: moving segments), and the results will be printed in the command window.
...
| allowChangePoints      | (optional) Set to 1 for finding change points in addition to pauses.                                                        |
| onlyChangePoints       | (optional) Set to 1 for only finding change points.                                                                         |
...
Change points are pauses whose length is 0.
